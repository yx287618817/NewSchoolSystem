"""
Django settings for 学校管理项目 project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'Main/teacher/templates'),
        ]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
...
DATABASES = {
    'default': {
        ...
        'NAME': 'goodgoodstudy',         # 你要存储数据的库名，事先要创建之
        'USER': 'admin',         # 数据库用户名
        'PASSWORD': 'admin',     # 密码
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'Main', 'teacher', 'static'),
]
